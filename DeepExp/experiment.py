...
class Experiment(object):
    ...
    def run(self):
        ...
        self.agent.env['Train'].reset(seed=self.cfg['seed'])
        self.agent.env['Train'].action_space.seed(self.cfg['seed'])
        self.agent.env['Test'].reset(seed=self.cfg['seed'])
        self.agent.env['Test'].action_space.seed(self.cfg['seed'])
        # Train && Test
